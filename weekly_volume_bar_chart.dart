...
const WeeklyVolumeChart({
  ...
  Widget build(BuildContext context) {
    //print("chart Data in Weekly ${chartData.volumes}");
   return Container(
    ...
    child: Column(
      ...
      //  Expanded(child: weeklyChart),
        ...
        child: IndexedStack(
          index: currentType == 0 ? 0: 1,
          children: [
            AnimatedWeeklyVolumeBarChart(chartData: chartData, height: 300),
            AnimatedRevenueLineChart(chartData: chartData, height: 300)
          ],
        ),
